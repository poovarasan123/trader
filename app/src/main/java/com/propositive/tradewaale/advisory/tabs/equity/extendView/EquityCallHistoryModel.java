...
public class EquityCallHistoryModel {

    String h_symbol, h_buy_value, h_calls_method, h_reco_pr, h_target, h_updated, h_updated_time;

    public EquityCallHistoryModel(String h_symbol, String h_buy_value, String h_calls_method, String h_reco_pr, String h_target, String h_updated, String h_updated_time) {
