...
public class DerivativeCallHistoryAdapter extends RecyclerView.Adapter<DerivativeCallHistoryAdapter.ViewHolder> {

    Context context;
    List<DerivativeCallHistoryModel> data;

    public DerivativeCallHistoryAdapter(Context context, List<DerivativeCallHistoryModel> data) {
    ...
    @NonNull
    @Override
    public DerivativeCallHistoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DerivativeCallHistoryAdapter.ViewHolder holder, int position) {
